...
const VERBS: ToolVerbs = {
	read_crm_history: "Consultou nossos e-mails e reuniões",
	read_company_history: "Consultou os dados da empresa",
	read_deal_history: "Consultou o negócio e seu histórico",
	search_crm: "Buscou o registro no CRM",
	resolve_linkedin_profile: "Buscou o perfil no LinkedIn",
	get_linkedin_profile: "Consultou um perfil do LinkedIn",
	get_contact_work_history: "Consultou o histórico profissional",
	fetch_contact_photo: "Obteve a foto do perfil",
	find_contact_socials: "Buscou outros perfis",
	set_contact_socials: "Conferiu o perfil com a conta",
	identify_contact: "Identificou o nome associado ao endereço",
	record_fact: "Registrou os resultados",
	write_brief: "Escreveu o histórico",
	write_workspace_profile: "Descreveu nossa empresa",
	research_person: "Pesquisou na internet",
	research_company: "Consultou o site da empresa",
	enrich_company: "Buscou a empresa",
	schedule_recheck: "Definiu a próxima revisão",
	record_job_change: "Sinalizou mudança de emprego",
	list_deals: "Revisou o funil de vendas",
	list_outstanding_work: "Buscou tarefas pendentes",
	set_chat_title: "Conversa nomeada",
	list_fields: "Consultou os campos do CRM",
	set_field_value: "Preencheu um campo personalizado",
	manage_fields: "Alterou os campos do CRM",
	archive_field: "Solicitou o arquivamento de um campo",

	load_skill: "Consultou as instruções",
	web_search: "Pesquisou na internet",
	web_fetch: "Consultou uma página",
	todo: "Atualizou o plano",
	ask_question: "Fez uma pergunta",
	agent: "Delegou parte da tarefa",
	connection_search: "Buscou uma ferramenta",
	bash: "Executou um comando",
	read_file: "Leu um arquivo",
	write_file: "Gravou um arquivo",
	glob: "Buscou arquivos",
	grep: "Pesquisou nos arquivos",
};
