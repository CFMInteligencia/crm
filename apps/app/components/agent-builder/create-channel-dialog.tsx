	...
	const create = useMutation(
		trpc.slack.createChannel.mutationOptions({
			onSuccess: async () => {
				...
				setOpen(false);
				setName("");
				toast.success("Criando canal no Slack.");
			},
		...
		<Dialog onOpenChange={setOpen} open={open}>
			...
			<DialogContent className="sm:max-w-(--container-narrow)">
				<DialogHeader>
					...
					<DialogDescription>
						O Comp AI cria o canal e entra nele. Depois, você pode adicionar o
						agente.
					</DialogDescription>
				</DialogHeader>
				...
				<div className="flex flex-col gap-4">
					<div className="flex flex-col gap-1.5">
						...
						<p className="text-muted-foreground text-xs">
							{slug && !valid
								...
								: `Nome do canal no Slack: #${slug || "renovacoes"}.`}
						</p>
					</div>
					...
					<div className="flex items-center gap-3">
						...
						<Label htmlFor="channel-private">
							Privado. Apenas pessoas convidadas têm acesso.
						</Label>
					</div>
				</div>
