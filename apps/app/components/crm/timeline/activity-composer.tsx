...
const PLACEHOLDER = {
	NOTE: "Registrar nota, ligação, e-mail, reunião ou tarefa…",
	CALL: "Qual foi o resultado da ligação?",
	EMAIL: "O que foi conversado?",
	MEETING: "Qual foi o resultado da reunião?",
