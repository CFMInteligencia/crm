	...
	const create = useMutation(
		trpc.deals.create.mutationOptions({
			onSuccess: async (deal) => {
				...
				toast.success(`${deal.name}: cadastro concluído.`);
				await setOpen(null);
				setName("");
				setAmount("");
				setCurrency("");
		...
		<Sheet open={open} onOpenChange={(next) => setOpen(next || null)}>
			...
			<SheetContent side="right">
				<SheetHeader>
					...
					<SheetDescription>
						Cada negócio pertence a uma empresa e tem um responsável.
					</SheetDescription>
				</SheetHeader>
				...
				>
					<FieldGroup>
						...
						<Field>
							...
							<FieldDescription>
								O negócio começa em aberto. Encerre-o no funil quando houver um
								resultado.
							</FieldDescription>
						</Field>
