	...
	const create = useMutation(
		trpc.companies.create.mutationOptions({
			onSuccess: async (company) => {
				...
				toast.success(`${company.name}: cadastro concluído.`);
				await setOpen(null);
				setName("");
				setDomain("");
		...
		<Sheet open={open} onOpenChange={(next) => setOpen(next || null)}>
			...
			<SheetContent side="right">
				<SheetHeader>
					...
					<SheetDescription>
						Informe o nome e o domínio. O agente preenche logotipo, descrição,
						setor, endereço e redes sociais.
					</SheetDescription>
				</SheetHeader>
				...
				>
					<FieldGroup>
						...
						<Field>
							...
							/>
							<FieldDescription>
								Você pode informar a URL completa. O sistema usa apenas o
								domínio, que deve ser único.
							</FieldDescription>
						</Field>
