			...
			? [
					{
						...
						status: slack.workspace
							...
							: "Conectado",
						bringsIn: "Integrantes e canais aos quais o aplicativo tem acesso",
						sends: "Mensagens para canais e pessoas autorizados",
			...
			? [
					{
						name: "Microsoft 365",
						status: "Conectado",
						bringsIn: "E-mails e contatos do Outlook",
						sends: "Nenhum envio",
					...
					<header className="flex items-start justify-between gap-4 px-(--spacing-block-inline)">
						<div className="flex flex-col gap-2">
							...
							<p className="max-w-2xl text-muted-foreground text-sm">
								Fontes de dados do CRM e permissões de envio em seu nome.
							</p>
						</div>
				...
				<div className="mx-auto flex w-full max-w-(--container-narrow) flex-1 flex-col justify-center gap-(--spacing-page-gap) text-center">
					<div className="flex flex-col gap-2 px-(--spacing-block-inline)">
						...
						<p className="text-muted-foreground text-sm leading-relaxed">
							Conecte uma ferramenta para importar informações do trabalho da
							equipe e reduzir o cadastro manual.
						</p>
					</div>
					<div className="flex flex-col divide-y rounded-lg border bg-card px-(--spacing-block-inline)">
						<StarterRow
							logo={GoogleLogo}
							name="Google Workspace"
							description="Associar e-mails e reuniões à empresa correta"
							href={`/${slug}/settings/connections/google`}
						/>
						<StarterRow
							logo={SlackLogo}
						...
						<StarterRow
							logo={MicrosoftLogo}
							name="Microsoft 365"
							description="Associar e-mails do Outlook à empresa correta"
							href={`/${slug}/settings/connections/microsoft`}
						/>
					</div>
					<p className="px-(--spacing-block-inline) text-muted-foreground text-sm">
						Procura outra integração?{" "}
						<Link
	...
	return (
		<section className="flex flex-col gap-4 rounded-lg border bg-card px-(--spacing-block-inline) py-4">
			...
			<div className="flex flex-col gap-2 pl-8 text-sm">
				<CapabilityRow label="Importa" value={bringsIn} />
