...
const SCOPES = {
	SITE_AND_SUBDOMAINS: "Site e subdomínios",
	EXACT_HOST: "Domínio exato",
} as const;
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					O script registra visitas apenas nestes domínios.
				</CardDescription>
			...
			{domains.length === 0 ? (
				<CardTableEmpty>
					Adicione o domínio do site para obter o script de rastreamento.
				</CardTableEmpty>
			) : (
					...
					{domains.map((domain) => (
						<SimpleTableRow key={domain.id}>
							...
							<TableCell className={`${CELL} text-right tabular-nums`}>
								{domain.pageViews.toLocaleString("pt-BR")}
							</TableCell>
