			...
			<Sheet open={open} onOpenChange={(next) => setOpen(next || null)}>
				...
				<SheetContent side="right">
					<SheetHeader>
						...
						<SheetDescription>
							A chave usa suas permissões de leitura e alteração.
						</SheetDescription>
					</SheetHeader>
						...
						<FieldGroup>
							<Field>
								...
								<Input
									...
									placeholder="Integração contínua"
									maxLength={64}
									autoComplete="off"
									autoCapitalize="off"
									autoCorrect="off"
								...
								/>
								<FieldDescription>
									Use um nome fácil de reconhecer, como o serviço que usa a
									chave.
								</FieldDescription>
							</Field>

							<Field>
								<FieldLabel htmlFor={expirationId}>Expira em</FieldLabel>
								<Select
									value={expiration}
									onValueChange={(value) =>
